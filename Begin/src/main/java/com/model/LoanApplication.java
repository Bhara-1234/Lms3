...
public class LoanApplication {
	...
	public String toString() {
		return "LoanApplication [lnap_id=" + lnap_id + ", lnap_cust_id=" + lnap_cust_id + ", lnap_apdate=" + lnap_apdate
				...
				+ lnap_emi_range_from + ", lnap_emi_range_to=" + lnap_emi_range_to + ", lnap_noy=" + lnap_noy
	...
	public LoanApplication(int lnap_id, int lnap_cust_id, Date lnap_apdate, int lnap_lnty_id, int lnap_amount,
			int lnap_emi_range_from, int lnap_emi_range_to, int lnap_noy, int lnap_nom_requested, int lnap_cibil_Score,
			String lnap_status, String lnap_conclusion_remarks, int lnap_processed_user, Date lnap_processed_Date) {
		super();
	...
	public void setLnap_apdate(String lnap_apdate) {
		String app_date=lnap_apdate;
		Date date = null;
		try {
			
		 date = Date.valueOf(app_date);
		}
		catch(Exception e) {
			
		}
		this.lnap_apdate = date;
	}
	...
	public void setLnap_processed_Date(String lnap_processed_Date) {
		String processedDate = lnap_processed_Date;
		Date date = null;
		try {
			date = Date.valueOf(processedDate);
			
		}
		catch(Exception e) {
			
		}
		this.lnap_processed_Date = date;
	}
