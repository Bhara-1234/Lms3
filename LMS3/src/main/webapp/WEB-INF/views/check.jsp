...
<body>
    ...
    <div class="container">
        <div class="form-container">
            ...
            <div class="form-group">
                ...
                <input type="text" id="cd" class="form-control" onchange="dispose()">
            </div>
            <div class="form-group">
    ...
    <script>
     function dispose(){
    	 var a = parseFloat(document.getElementById("cd").value);
    	 var b= (a*0.3)/12;
    	 document.getElementById("ef").value = b.toFixed(2);
     }
        function calculate() {
